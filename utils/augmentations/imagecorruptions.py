...
def gaussian_noise(x, severity=1):
    c = [0.05, 0.07, 0.09, 0.12, 0.15][severity - 1]
...
def defocus_blur(x, severity=1):
    c = [(3, 0.1), (4, 0.5), (5, 0.5), (7, 0.5), (9, 0.5)][severity - 1]
...
def dark(x, severity):
    c = [0.60, 0.54, 0.48, 0.42, 0.36][severity - 1]
    x = np.array(x) / 255.
...
def contrast(x, severity=1):
    c = [0.4, 0.33, 0.26, 0.18, 0.1][severity - 1]
...
def saturate(x, severity=1):
    c = [(2, 0), (0.3, 0), (0.2, 0), (0.1, 0), (5, 0.1)][severity - 1]
